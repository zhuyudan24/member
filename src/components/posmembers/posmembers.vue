          ...
          <div class="handler-search">
            ...
            <div class="handler-setting">
              ...
              <el-button
                ...
                style="width: 32px; line-height: 30px; padding: 0px; margin: 0 5px;"
              ></el-button>
              <el-popover
                placement="top-start"
                :width="popWidth"
            ...
            >
              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    ...
                    <span v-else-if="item == 'cancelAttentionTime'">
                      {{ scope.row.cancelAttentionTime | formatTime }}
                    </span>
              ...
              >
                <template slot-scope="scope">
                  <div class="operate">
                    <router-link
                      :to="{path:'/posmemberDetail', query:{memberId: scope.row.memberId , channel: 'posMember'}}"
                      class="operate-btn"
                    >查看</router-link>
                  </div>
                </template>
...
<script>
import posmembers from './posmembers';
export default { ...posmembers };
</script>
